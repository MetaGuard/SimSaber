...
from geometry import Plane2, Vector3
...
class GoodCutEvent:
    def __init__(self, buffer: SaberMovementBuffer, note_orientation, cut_point=None):
        ...
        self.cut_plane = Plane2(self.cut_plane_normal, cut_point)
    ...
    def update_after_cut(self, new_data):
        ...
        # print(f"Or Angle: {angle_with_normal} {new_data.cutPlaneNormal} {new_data.tipPos}")
    ...
    def calculate_acc(self):
        ...
        self.cutDistanceToCenter = dist

        cut_distance_raw_score = dist / 0.3
        cut_distance_raw_score = 1 - clamp(cut_distance_raw_score, 0, 1)
        self.acc = round_half_up(max_cut_score * cut_distance_raw_score)
